...
// parseo datos recibiendo las respuestas de la forma.
	$preg1 	= utf8_decode($_POST['pm1']);
	$preg2 	= utf8_decode($_POST['pm2']);
	$preg3 	= utf8_decode($_POST['pm3']);
	$preg4 	= utf8_decode($_POST['pm4']);
	$preg5 	= utf8_decode($_POST['pm5']);
	
	$time1 	= utf8_decode($_POST['tiempo1']);	//aqui viene la hora en que inicio a contestar.
	$time2 	 = time(); 							//termino de contestar.
	$diftime = $time2-$time1;  					// diferencia en segundos.
	    
	$buenas  = 0; 	$malas	 = 0; 	$puntos	 = 0; 	$observaciones = '¡Muy Bien! Felicitaciones';
	
	//obteniendo las respuestas correctas desde la clase Math.
	$resp1 = $obj_math->getRespuesta1();
	$resp2 = $obj_math->getRespuesta2();
	$resp3 = $obj_math->getRespuesta3();
	$resp4 = $obj_math->getRespuesta4();
	$resp5 = $obj_math->getRespuesta5();
